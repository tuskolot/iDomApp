...
public class iDOmSettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || DefaultScreenPreferenceFragment.class.getName().equals(fragmentName);
    }
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), iDOmSettingsActivity.class));
                return true;
            }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class DefaultScreenPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
